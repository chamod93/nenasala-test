...
<html lang="en">
    <head>
        ...
        <title>Nenasala Result Management System</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Nenasala Result Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<p><b>Student Registration No. :</b> <?php echo htmlentities($row->RollId);?>
...
?>
<tr>
                                                <th scope="row" colspan="2">Final Grade</th>
...
<strong>Please check the number and try again!</strong>
<?php
